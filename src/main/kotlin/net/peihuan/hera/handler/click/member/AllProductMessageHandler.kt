...
@Component
class AllProductMessageHandler(val zyProperties: ZyProperties) : AbstractMenuAndMessageHandler() {
    ...
    override fun handleMenuClick(wxMpXmlMessage: WxMpXmlMessage): WxMpXmlOutMessage {
        val url = buildAllProductUrl(wxMpXmlMessage.fromUser, zyProperties.appid)
